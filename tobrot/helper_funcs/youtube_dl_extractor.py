...
async def extract_youtube_dl_formats(
    ...
    if e_response:
        ...
        error_message = e_response.replace(
            "informe esse problema em https://yt-dl.org/bug . Certifique-se de estar usando a versão mais recente; consulte https://yt-dl.org/update sobre como atualizar. Certifique-se de chamar youtube-dl com o sinalizador --verbose e incluir sua saída completa.",
            "",
        )
    ...
    if t_response:
        ...
        if cf_name:
            succss_mesg = f"""Selecione o formato desejado | {cf_name}"""
        else:
            succss_mesg = f"""Selecione o formato desejado"""
