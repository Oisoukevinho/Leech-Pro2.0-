...
async def youtube_dl_call_back(bot, update):
    ...
    if current_user_id != current_touched_user_id:
        await bot.answer_callback_query(
            ...
            text="Não toque nisso. Este sanguessuga não foi iniciado por você..😡😡😡",
            show_alert=True,
            cache_time=0,
        )
        return False, None
    ...
    #
    await update.message.edit_caption(caption="**Tentando fazer o download.... Por favor, aguarde.. ⌛⌛**")
    ...
    ad_string_to_replace = "informe esse problema em https://yt-dl.org/bug . Certifique-se de estar usando a versão mais recente; consulte https://yt-dl.org/update sobre como atualizar. Certifique-se de chamar youtube-dl com o sinalizador --verbose e incluir sua saída completa."
